...
work <- tribble(
  ...
  "Adjunct Professor", "Kansas State University", "September", 2018, "Present", NA, "Remote", "Research – Exploring new applications and approaches to applied data analytics", 
  "Adjunct Professor", "Kansas State University", "September", 2018, "Present", NA, "Remote", "Education – Developing materials to make applied data analytics more accessible", 
